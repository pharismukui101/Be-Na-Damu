...
class Acknowledgement(models.Model):
    ...
    Request = models.ForeignKey(
        "blood.Request", related_name="blood", on_delete=models.CASCADE, null=True)
    
    def sumOfPotentialBlood(self):
        donors=Donor(self.donor)
        #requests=Request(self.Request)
        return donors.objects.aggregate(Sum=donors.donationAmount)
